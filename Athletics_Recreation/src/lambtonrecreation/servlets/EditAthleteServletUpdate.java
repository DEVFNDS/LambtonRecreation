...
/**
 * Servlet implementation class EditAthleteServletUpdate
 */
@WebServlet("/editathleteupdate")
public class EditAthleteServletUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditAthleteServletUpdate() {
        super();
		...
		try {
        	if( request.getSession().getAttribute("username") != null) {
    			...
    			if(username != null) {
	                ...
	                int status = AthleteDao.updateAthlete(athlete, username);
	                if (status > 0) {
