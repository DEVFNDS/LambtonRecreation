...
%>
        ...
        <div class="event-card">
            ...
            <p><strong>Registration Deadline:</strong><%= obj.getRegistrationDeadline() %></p>
             <a href='EditEventServlet?id=<%= obj.getId() %>'> <button  class="edit <%= (showAnchor != null && !showAnchor) ? "hidden" : "" %>">Edit</button> </a>
           <a href='deleteevent?id=<%= obj.getId() %>'> <button class="delete <%= (showAnchor != null && !showAnchor) ? "hidden" : "" %>">Delete</button> </a>
